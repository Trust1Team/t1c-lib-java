...
public class OcvError {
    ...
    public OcvError withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public OcvError withErrorCode(Integer errorCode) {
        this.errorCode = errorCode;
        return this;
    }
    ...
    public OcvError withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public OcvError withMoreInfoUrl(String moreInfoUrl) {
        this.moreInfoUrl = moreInfoUrl;
        return this;
    }
    ...
    public OcvError withStackTrace(String stackTrace) {
        this.stackTrace = stackTrace;
        return this;
    }
