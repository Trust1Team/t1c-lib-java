...
public interface GclEmvRestClient {
    ...
    Call<T1cResponse<List<GclEmvApplication>>> getEmvApplications(@Path("containerId") String containerId, @Path("reader") String readerId) throws RestException;

    @GET(CONTAINER_AND_READER_CONTEXT_PATH + "/application-data")
    Call<T1cResponse<GclEmvApplicationData>> getEmvApplicationData(@Path("containerId") String containerId, @Path("reader") String readerId) throws RestException;

    @POST(CONTAINER_AND_READER_CONTEXT_PATH + "/issuer-public-key-certificate")
    Call<T1cResponse<GclEmvPublicKeyCertificate>> getEmvIssuerPublicKeyCertificate(@Path("containerId") String containerId, @Path("reader") String readerId, @Body GclEmvAidRequest request) throws RestException;

    @POST(CONTAINER_AND_READER_CONTEXT_PATH + "/icc-public-key-certificate")
    Call<T1cResponse<GclEmvPublicKeyCertificate>> getEmvIccPublicKeyCertificate(@Path("containerId") String containerId, @Path("reader") String readerId, @Body GclEmvAidRequest request) throws RestException;

    @GET(CONTAINER_AND_READER_CONTEXT_PATH)
    Call<T1cResponse<GclEmvAllData>> getEmvAllData(@Path("containerId") String containerId, @Path("reader") String readerId) throws RestException;
