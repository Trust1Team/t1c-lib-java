 ...
 * @since 2017
 */
public class MobibContainer extends GenericContainer<MobibContainer> {
    private static final Logger log = LoggerFactory.getLogger(MobibContainer.class);

    @Override
    protected MobibContainer createInstance(String readerId, CommonContainerRestClient httpClient, String pin) {
        return null;
    }
