...
public class AventraAllData implements AllData {
    ...
    public AventraAllData withId(GclPtIdData id) {
        this.id = id;
        return this;
    }
    ...
    public AventraAllData withAuthenticationCertificate(T1cCertificate authenticationCertificate) {
        this.authenticationCertificate = authenticationCertificate;
        return this;
    }
    ...
    public AventraAllData withNonRepudiationCertificate(T1cCertificate nonRepudiationCertificate) {
        this.nonRepudiationCertificate = nonRepudiationCertificate;
        return this;
    }
    ...
    public AventraAllData withRootAuthenticationCertificate(T1cCertificate rootAuthenticationCertificate) {
        this.rootAuthenticationCertificate = rootAuthenticationCertificate;
        return this;
    }
    ...
    public AventraAllData withRootCertificate(T1cCertificate rootCertificate) {
        this.rootCertificate = rootCertificate;
        return this;
    }
    ...
    public AventraAllData withRootNonRepudiationCertificate(T1cCertificate rootNonRepudiationCertificate) {
        this.rootNonRepudiationCertificate = rootNonRepudiationCertificate;
        return this;
    }
}
