...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*String auth = t1cClient.authenticate("57a3e2e71c48cee9", new GclAuthenticateOrSignData().withData("dWq99zklgwsr54Mah+Ki+Y5w0LUi2FnBoYTQENSf3PM=").withPin("8213"));
        ...
        System.out.println("AUTH: " + gson.toJson(container.getAuthenticationCertificate(false)));
        System.out.println("ROOT: " + gson.toJson(container.getRootCertificate(false)));
        System.out.println("RRN: " + gson.toJson(container.getRrnCertificate(false)));
        System.out.println("CITIZEN: " + gson.toJson(container.getCitizenCertificate(false)));
        System.out.println("NONREP: " + gson.toJson(container.getNonRepudiationCertificate(false)));
